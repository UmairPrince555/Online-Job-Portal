                            ...
                            <td>
                                <table width="100%" border="1" bordercolor="#1CB5F1">
                                    <tr>
                                        ...
                                        <th height="32" bgcolor="#1CB5F1">
                                            <div align="left" class="style11 style7 style8">Approve News</div>
                                        </th>
                                        <th bgcolor="#1CB5F1">
                                    ...
                                    $sql = "select * from news_master where Status = 'Pending'";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div align="left" class="style11 style7 style8"><a
                                                        href="NewsApproval.php?NewsId=<?php echo $Id; ?>">Approve</a></div>
                                            </td>
                                            <td>
                                                <div align="left" class="style11 style7 style8"><a
