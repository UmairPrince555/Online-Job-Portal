...
<form method="post" action="UpdateProfile.php">
                <table width="100%" border="1" cellspacing="2" cellpadding="2">
                  <tr>
                    <td><strong>JobSeekId ID:</strong></td>
                  ...
                  <tr>
                    ...
                    <td><span id="sprytextfield2">
                      <label>
                      <input name="txtAddress" type="text" id="txtAddress" value="<?php echo $row['Address'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><span id="sprytextfield8">
                      <label>
                      <input name="txtBirth" type="text" id="txtBirth" value="<?php echo $row['BirthDate'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
                  <tr>
